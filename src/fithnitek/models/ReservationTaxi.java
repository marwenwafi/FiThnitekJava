...
public class ReservationTaxi {
 ...
 public ReservationTaxi(int iddemande, int iduser, int id, float prix, String lieudepart, String lieuarrive, String region, String periode, String dated ,String username) {
        this.iduser = iduser;
        this.iddemande = iddemande;
        this.id = id;
        this.prix = prix;
    ...
    public ReservationTaxi(int id, float prix, String lieudepart, String lieuarrive, String region, String periode, String dated) {
    //    public ReservationTaxi(int id, float prix, String lieudepart, String lieuarrive, String region, String periode, String dated,String username) {
        this.id = id;
        this.prix = prix;
        this.lieudepart = lieudepart;
        this.lieuarrive = lieuarrive;
