...
public class Reservation_Colis {
    ...
    public Reservation_Colis(int id_ReservationCol, double HauteurResv, double LargeurResv, double PrixResv, int id, int id_Offre, double LongueurResv) {
        ...
        public Reservation_Colis(int id_ReservationCol, double HauteurResv, double LargeurResv, double PrixResv, int id, int id_Offre, double LongueurResv,String Arrive,String Depart,String username) {
        this.id_ReservationCol = id_ReservationCol;
        this.HauteurResv = HauteurResv;
        this.LargeurResv = LargeurResv;
        this.PrixResv = PrixResv;
        ...
        this.Username=username;
         ...
         public Reservation_Colis(int id_ReservationCol, double HauteurResv, double LargeurResv, double PrixResv, int id, int id_Offre, double LongueurResv,String Arrive,String Depart,String username,int Number) {
        this.id_ReservationCol = id_ReservationCol;
        this.HauteurResv = HauteurResv;
        this.LargeurResv = LargeurResv;
        this.PrixResv = PrixResv;
