...
public class AjouterOffreController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
       ...
       ArrayList<Offre_Colis> OffreArray =  (ArrayList<Offre_Colis>) OC.afficherOffreColis(user.getId()); 
...
Date dateP = Date.from(instant);
	...
	dateString = sdfr.format( gettedDatePickerDate );
        ServiceColis OC = new ServiceColis();
        Offre_Colis O=new Offre_Colis(dateString,depart.getText(),arrive.getText(),Integer.parseInt(prix.getText()),Double.parseDouble(hauteur.getText()),Double.parseDouble(largeur.getText()),voiture.getText(),user.getId(),Double.parseDouble(longueur.getText()));
...
voiture.setText(O.getVoiture());
    ...
    @FXML
    private void GOTOCOlisoffre(ActionEvent event) throws IOException {
